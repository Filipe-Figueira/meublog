...
function renderizar($diretorio, $arquivo, $dados = array()) {
     ...
     * @param $diretorio -> A pasta que contém nossos arquivos HTML
     * @param $arquivo -> O arquivo que deve ser carregado
     * @param $dados[] (OPCIONAL)-> O array que contém os dados a serem apresentados 
     */
